...
public:
	...
	//tile manipulation
	virtual Region::type_t SetThis(int x, int y, Region::type_t v);
	virtual Region::type_t GetThis(int x, int y);

	virtual Region::type_t SetNext(int x, int y, Region::type_t v);
	virtual Region::type_t GetNext(int x, int y);
